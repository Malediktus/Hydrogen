...
void VulkanRendererAPI::SetClearColor(const Vector4& color) {
  ZoneScoped;
  HY_LOG_TRACE("Set Vulkan clear color to ({}, {}, {}, {})", color.r, color.g,
               color.b, color.a);
}

void VulkanRendererAPI::Clear(const ClearBuffer clearBuffer) { ZoneScoped; }
...
void VulkanRendererAPI::ConfigureDepthTesting(const bool enable,
                                              const bool depthMask,
                                              const DepthTestFunc func) {
  ZoneScoped;
  HY_LOG_TRACE(
      "Configured Vulkan depth testing: (enable: {}, mask: {}, func: {})",
      enable, depthMask, (int)func);
}

void VulkanRendererAPI::ConfigureStencilTesting(
  ...
  ZoneScoped;
  HY_LOG_TRACE(
      "Configured Vulkan stencil testing: (enable: {}, writeMask: {}, "
      "readMask: {}, ref: {}, stencilFailAction: {}, "
      "stencilPassDepthFailAction: {}, stencilPassDepthPassAction: {})",
      enable, writeMask, readMask, ref, (int)stencilFailAction,
      (int)stencilPassDepthFailAction, (int)stencilPassDepthPassAction);
}

void VulkanRendererAPI::ConfigureBlending(const bool enable,
                                          ...
                                          const BlendingFunc blendingFuncA) {
  ZoneScoped;
  HY_LOG_TRACE(
      "Configured Vulkan blending testing: (enable: {}, blendingFunc1: {}, "
      "blendingFunc2: {}, blendingFuncR: {}, blendingFuncG: {}, blendingFuncB: "
      "{}, blendingFuncA: {})",
      enable, (int)blendingFunc1, (int)blendingFunc2, (int)blendingFuncR,
      (int)blendingFuncG, (int)blendingFuncB, (int)blendingFuncA);
}

void VulkanRendererAPI::ConfigureCulling(const bool enable,
                                         const CullingType type) {
  ZoneScoped;
  HY_LOG_TRACE("Configured Vulkan culling: (enable: {}, type: {})", enable,
               (int)type);
}
