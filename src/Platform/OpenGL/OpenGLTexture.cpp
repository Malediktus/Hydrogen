...
OpenGLTexture2D::OpenGLTexture2D(const int width, const int height, Texture2DUsageType usageType) {
    ZoneScoped;
    m_Width = width;
    m_Height = height;
    ...
    switch (usageType) {
    case Texture2DUsageType::Color:
        internalFormat = GL_RGBA8;
        format = GL_RGBA;
        break;
    case Texture2DUsageType::Depth:
        internalFormat = GL_DEPTH_COMPONENT32F;
        format = GL_DEPTH_COMPONENT;
        break;
    case Texture2DUsageType::Stencil:
        internalFormat = GL_STENCIL_INDEX8;
        format = GL_STENCIL_INDEX;
        break;
    case Texture2DUsageType::DepthStencil:
...
OpenGLTexture2D::OpenGLTexture2D(const int width, const int height, const void* data, Texture2DUsageType usageType) {
    ZoneScoped;
    m_Width = width;
    m_Height = height;
    glGenTextures(1, &m_RendererID);
