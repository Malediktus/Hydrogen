...
class VulkanVertexArray : public VertexArray {
 public:
  ...
  virtual void SetRenderPrimitive(RenderPrimitive primitive) override { m_Primitive = primitive; }

  virtual RenderPrimitive GetRenderPrimitive() const override { return m_Primitive; }
