...
class VulkanRendererAPI : public RendererAPI {
 public:
  ...
  virtual void ConfigureDepthTesting(const bool enable, const bool depthMask,
                                     const DepthTestFunc func) override;
  ...
  virtual void ConfigureBlending(const bool enable,
                                 ...
                                 const BlendingFunc blendingFuncA) override;
  virtual void ConfigureCulling(const bool enable,
                                const CullingType type) override;
